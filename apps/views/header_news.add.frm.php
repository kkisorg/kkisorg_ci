                ...
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('header_news_adm/afrm_proc')?>" method="post" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" maxlength="200" value="<?php echo set_value('name', isset($name) ? $name : null);?>">
                    </div>

				    <div class="form-group">
                        <label for="short_desc">Short Description<font style="color:red;font-size:bolder"> * </font></label>
                        <textarea name="short_desc" cols="38" rows="6"><?php echo set_value('short_desc', isset($short_desc) ? $short_desc : null);?></textarea>
                    </div>
                    ...
                    <div class="form-group">
					    ...
					    <br />
					    <img src="<?=PATH_USERFILES;?>header_news/<?=isset($jData->image) ? $jData->image : null;?>" />
                    </div>
