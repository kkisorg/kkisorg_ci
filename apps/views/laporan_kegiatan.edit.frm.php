...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Laporan Kegiatan &raquo; Edit &raquo; <?=$jData->laporan_kegiatan_title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('laporan_kegiatan_adm/efrm_proc')?>" method="post" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Title" maxlength="200" value="<?php echo set_value('name',  $jData->laporan_kegiatan_title);?>" >
                    </div>
				    ...
				    <div class="form-group">
                        ...
                        $oFCKeditor->Value		= $jData->laporan_kegiatan_content ;
                        $oFCKeditor->Create() ;
                        ?>
                    </div>
