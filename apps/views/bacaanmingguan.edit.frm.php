...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bacaan Mingguan &raquo; Edit &raquo; <?=$jData->title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('bacaanmingguan_adm/efrm_proc')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="input-group date" data-provide="datepicker">
                    <input name="contentDt" type="text" class="form-control" value="<?php echo set_value('contentDt',  $jData->content_dt);?>">
				    ...
				    <div class="form-group">
					    ...
					    <br />
                        <? $fpath = FILEPATH_USERFILES."bacaanmingguan/".$jData->image;
                        if(file_exists($fpath)):?>
					    <a href="<?php echo base_url(); ?>gui/userfiles/bacaanmingguan/<?=$jData->image;?>">Download file</a>
                        <? endif ?>
                    </div>
				    ...
				    <div class="form-group">
                        ...
                        $oFCKeditor->Value		= $jData->content ;
                        $oFCKeditor->Create() ;
                        ?>
                    </div>
