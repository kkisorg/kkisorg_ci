...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pelayanan &raquo; Edit &raquo; <?=$jData->pelayanan_title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('pelayanan_adm/efrm_proc')?>" method="post" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Title" maxlength="200" value="<?php echo set_value('name',  $jData->pelayanan_title);?>" >
                    </div>
				    ...
				    <div class="form-group">
                        ...
                        $oFCKeditor->Value		= $jData->pelayanan_content ;
                        $oFCKeditor->Create() ;
                        ?>
                    </div>
