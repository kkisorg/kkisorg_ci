...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Header News &raquo; Edit &raquo; <?=$jData->title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('header_news_adm/efrm_proc')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="short_desc" cols="38" rows="6"><?php echo set_value('short_desc',  $jData->short_desc);?></textarea>
                    </div>
                    ...
                    <div class="form-group">
					    ...
					    <br />
					    <img src="<?=PATH_USERFILES;?>header_news/<?=$jData->image;?>" class="img-responsive" />
                    </div>
