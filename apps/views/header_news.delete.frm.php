...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Header News &raquo; Delete</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('header_news_adm/dfrm_proc')?>" method="post">
				    ...
				    <fieldset> 
								...
								<div class=""> 
									...
									( This can not be undone. )
										...
										<ul>
										  <li><p class=''>Title</p>&nbsp;<?=$jData->title ?></li>
										  <li><p class=''>Short Description</p>&nbsp;<?=$jData->short_desc ?></li>
										</ul>
