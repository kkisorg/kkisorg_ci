...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Laporan Kegiatan &raquo; Delete</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('laporan_kegiatan_adm/dfrm_proc')?>" method="post">
				    ...
				    <fieldset> 
								...
								<div class=""> 
									...
									( This can not be undone. )
										...
										<ul>
										  <li><p class=''>Title</p>&nbsp;<?=$jData->laporan_kegiatan_title ?></li>
										</ul>
