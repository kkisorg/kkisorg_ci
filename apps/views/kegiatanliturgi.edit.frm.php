...
<!--// s-content //-->	
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Kegiatan Liturgi &raquo; Edit &raquo; <?=$jData->kegiatan_title;?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			*/
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form action="<?=site_url('kegiatanliturgi_adm/efrm_proc')?>" method="post" enctype="multipart/form-data">
