...
/*
|--------------------------------------------------------------------------
| @Filename: kegiatanliturgi_adm.php
|--------------------------------------------------------------------------
| @Desc    : Blog Adm
| @Date    : 2012-06-16
| @Version : 1.0 
...
class Kegiatanliturgi_adm extends CI_Controller 
{

	function Kegiatanliturgi_adm()
	{
		parent::__construct();	
		...
		//more
		$this->load->model('Kegiatanliturgi_model',     'kegiatanliturgi_model');
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('KEGIATANLITURGI.LIST');
	...
	**/
	function ajx_view($v=true)
	{
		...
		//role-list
		$rdata = $this->kegiatanliturgi_model->get(array(
						'order' => $fdata['order'],
						'limit' => $fdata['limit'],
		...
		//view
		if(!$v)
		   $this->load->view('kegiatanliturgi.view.php',$vdata);
		else
		   echo $json_str;
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('KEGIATANLITURGI.ADD');
		...
		//view
		$this->load->view('kegiatanliturgi.add.frm.php',$vdata);
	...
	**/
	function afrm_proc()
	{
		...
		if(!$this->input->get_post('Save'))
		{
			...
			//fwd
			$this->load->view('kegiatanliturgi.add.frm.php',$pdata);
			return;            
		...
		//exec
		$pret                = $this->kegiatanliturgi_model->add($pdata);
		if(!$pret['status'])
		{
		...
		//fwd
		redirect(site_url("kegiatanliturgi_adm/view"));
	...
	**/	
	function set_rules_for_add()
	{
		...
		$this->form_validation->set_rules('name',     'Kegiatanliturgi Title',       'trim|required');
		$this->form_validation->set_rules('content',     'Kegiatanliturgi Content',       'trim|required');
	}
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('KEGIATANLITURGI.EDIT');
		...
		//get rec
		$gdata = $this->kegiatanliturgi_model->select_by_id( array('id' => $id) );
		...
		$vdata['jData_Hidden']      = array('id'=> $id, 'hash' => $hash, 'name' => $gdata['data']->kegiatan_title);
		//set data
		$vdata['jData_publish_list'] = $this->config->item('DEFAULT_PUBLISH_NOTPUBLISH_LIST');
		...
		//view
		$this->load->view('kegiatanliturgi.edit.frm.php',$vdata);
	...
	**/
	function efrm_proc()
	{
		...
		//upd8 it;-)
		$ddata = $this->kegiatanliturgi_model->update($pdata);
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('KEGIATANLITURGI.DELETE');
		...
		//view
		$this->load->view('kegiatanliturgi.delete.frm.php',$vdata);
	...
	**/
	function dfrm_proc()
	{
		...
		//delete it;-)
		$ddata = $this->kegiatanliturgi_model->delete(array(
								'id'         => $id,
...
/* End of file kegiatanliturgi.php */
/* Location: ./apps/controllers/kegiatanliturgi.php */