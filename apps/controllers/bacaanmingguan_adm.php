...
class Bacaanmingguan_adm extends Controller 
{
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('BACAANMINGGUAN.EDIT');
	...
	**/
	...
	{
		//perms
		$this->etc->check_permission('BACAANMINGGUAN.DELETE');
...
/* End of file bacaanmingguan.php */
/* Location: ./apps/controllers/bacaanmingguan.php */