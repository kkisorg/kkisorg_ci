    ...
    return $(this).each(function() {
      ...
      $(keys).each(function(i, key) {
          if (currentKey.name == key.name)
              keyLinks.push("<ul><li><a href='#' class='selected'>" + key.name + "</a></li></ul>");
          else
              keyLinks.push("<ul><li><a href='#'>" + key.name + "</a></li></ul>");
      });


      var $this = $(this);
      var keysHtml = $("<div class='transpose-keys pagination pagination-centered'></div>");
