...
var MooDataTable = new Class({
	...
	createElements: function() {
		...
		var colspan = this.options.headers.length;
		var structureHtml = "<table><thead><tr></tr></thead><tfoot><tr><td colspan=\"" + colspan + "\"><span class=\"moo-foot-left\"></span><span class=\"moo-foot-right\"></span></td></tr></tfoot><tbody></tbody></table>";
	...
	requestData: function(page) {
		...
		}).send("page=" + page + "&perPage=" + this.options.perPage + '&sort=' + this.sort + '&sortOrder=' + this.sortOrder + '&bust=' + new Date().getTime() + '&xMore=' + this.options.xtraData);
		this.page = page;
